...
public class Student_login_servlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            StudentDao dd = new StudentDao(AbstractDao.getConnection());
            Student student = dd.getLogin(Integer.parseInt(reg), pass);
            if (student == null) {
                response.sendRedirect("index.jsp?task=errorPage");
