...
<%@page import="entity.StudentxTestBO"%>
<%@page import="DAO.StudentxTestDA"%>
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-12 text-center">
       ...
       StudentxTestDA j=new StudentxTestDA(AbstractDao.getConnection());
       StudentDao jj=new StudentDao(AbstractDao.getConnection());
             ArrayList<StudentxTestBO>list=j.getAll5();
        
for(StudentxTestBO jjj:list)
{
  %>
      <!-- feature item -->
      <div class="col-md-6 mb-80">
        <div class="d-flex feature-item">
          ...
          <div>
            <h4><%=jjj.getStudent().getReg_no()%></h4>
