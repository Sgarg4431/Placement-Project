  ...
  <div class="container">
      ...
      <div class="row contact-bg p-5 rounded mb-5 ">
          <div class="col-lg-7 mb-4 mb-lg-0 ">
              <form action="view_profile_servlet">
                 <table>
                  <tr>
                 ...
                 <tr>
                        ...
                        <td><input type="number" value="<%=((Student)session.getAttribute("user")).getReg_no()%>" placeholder="25648" class="form-control mb-3" name="registration" required></td>
                    </tr>
                    <tr>
                      <td>
                    &nbsp;
                    ...
                    <tr>
                        <td>Name&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td><input type="text" value="<%=((Student)session.getAttribute("user")).getName()%>" name="Name" class="form-control mb-3" placeholder="Enter Your Name" required></td>
                    </tr>
                    <tr>
                      <td>
                    &nbsp;
                  ...
                  <tr>
                        ...
                        <td><input type="password" value="<%=((Student)session.getAttribute("user")).getPassword()%>" placeholder="Enter password" class="form-control mb-3" name="password" required></td>
                    </tr>
                    <tr>
                      <td>
                    &nbsp;
                    <tr>
                        <td>Email&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td><input type="email" value="<%=((Student)session.getAttribute("user")).getEmail()%>" name="Email"  class="form-control mb-3" placeholder="abc@gmail.com" required></td>
                    </tr>
                    <tr>
                      <td>
                    &nbsp;
                    ...
                    <tr>
                        <td>Date-Of-Birth&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td><input type="date" value="<%=((Student)session.getAttribute("user")).getDate_of_birth()%>" name="Date-Of-Birth" class="form-control mb-3" placeholder="Enter your DOB" required></td>
                    </tr>
                    <tr>
                      <td>
                    &nbsp;
                     ...
                     <tr>
                        <td>Gender&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</td>
                        <td><input type="radio" name="Gender">&nbsp;&nbsp;Male &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Gender">&nbsp;&nbsp;Female &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" name="Gender" required>&nbsp;&nbsp;Others</td>
                    </tr>
                ...
                <tr>
                  ...
                  <td> <h4>Education Details&nbsp;&nbsp;&nbsp;</h4><ul><li class="application-question">
                    <li >
                      ...
                      <tr>
                        <td>Metric_Marks</td>
                        <td><input type="text" class="form-control mb-3" name="Metric_Marks" placeholder="Enter 10th marks" required></td>
                    </tr>
                    <tr>
                        <td>Secondary_Marks</td>
                        <td><input type="text" name="Secondary_Marks" class="form-control mb-3" placeholder="Enter 12th Marks" required></td>
                    </tr>
                    <tr>
                      <td>College_Name</td>
                      <td><input type="text" name="College_Name" placeholder="Institute"  class="form-control mb-3" required></td>
                  </tr>

                  <tr>
                      <td>Graduation_type</td>
                      <td><input type="text" class="form-control mb-3" name="Graduation_type" placeholder="BTech/Bsc/etc" required></td>
                  </tr>
                  <tr>
                      <td>Graduation_Stream</td>
                      <td><input type="text"  class="form-control mb-3" name="Graduation_Stream" placeholder="Stream" required></td>
                  </tr>
                  <tr>
                      <td>Graduation_CGP</td>
                      <td><input type="text" class="form-control mb-3" name="Graduation_CGP" placeholder="Enetr the last sem cgp" required></td>
                  </tr>
                  <tr>
                      <td>Graduation_Year</td>
                      <td><input type="year" class="form-control mb-3" name="Graduation_Year" placeholder="Year" required></td>
                  </tr>
...
&nbsp;
  ...
  <tr>
    <td>City</td>
    <td><input type="text" name="City" placeholder="Enter City" class="form-control mb-3" ></td>
</tr>
<tr>
  <td>State</td>
  <td><input type="text" name="State" placeholder="Enter State" class="form-control mb-3" ></td>
</tr>
<tr>
  <td>
    Country
   ...
   <tr>
    ...
    &nbsp;
          ...
          <tr>
            ...
            <td><input type="text" placeholder="Enter Current Company(if any)" name="Current_Company" class="form-control mb-3" ></td>
        </tr>
             </ul>
      </td>  
            ...
            &nbsp;
                ...
                <td> <ul>
                  ...
                  <tr>
                      ...
                      <td><textarea type="text" placeholder="Enter Your Achievements" name="Achievements" class="form-control mb-3" style="width: 200%; height: 3cm;" ></textarea></td>
                  </tr>
                     </ul>
              </td>  
              <tr>
          ...
          &nbsp;
              ...
              <td> <ul>
                ...
                <tr>
                  <td><h4>Skills</h4></td>
                  <td><textarea type="text" placeholder="Enter Your Skills" name="Skills" class="form-control mb-3" style="width: 200%; height: 3cm;"></textarea></td>
              </tr>
                   </ul>
                   <tr>
                    <td>
              ...
              &nbsp;
                ...
                <td> <ul>
                  ...
                  <tr>
                      ...
                      <td><textarea type="text" placeholder="Enter Your Interests" name="Interests" class="form-control mb-3" style="width: 200%; height: 3cm;"></textarea></td>
                  </tr>
                     </ul>
              </td>  
              <tr>
          ...
          &nbsp;
              ...
              <td> <h4>Links</h4><ul>
                ...
                <tr>
                    <td>Github</td>
                    <td><input type="text" name="Github" class="form-control mb-3" ></td>
                </tr>
                <tr>
                  <td>linkedin</td>
                  <td><input type="text" name="linkedin" class="form-control mb-3" ></td>
                  
              </tr>
              <tr>
                  <td>Others</td>
                  <td><input type="text" name="Others" class="form-control mb-3" ></td>
            ...
            <td> <ul>
              ...
              <tr>
                 ...
                 <td><h4>Additional Info</h4></td>
                  <td><textarea type="text" placeholder="Add a cover Letter or anything else you want to share" name="Additional_Info" class="form-control mb-3" style="width: 200%; height: 3cm;"></textarea></td>
              </tr>
                 </ul>
          </td>  
                   </ul>
        ...
        <tr>
            ...
            &nbsp;
                 ...
                 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                   <button type="submit" value="submit" class="btn btn-secondary">Submit Application</button>
